...
import { CottageOutlined, LibraryBooksOutlined, TravelExploreOutlined, MenuRounded } from '@mui/icons-material';
...
export const mainMenuConfig: MenuItem[] = [
  ...
  { id: 2, name: 'Blog', path: '/blog', icon: <LibraryBooksOutlined sx={{ fontSize: 18 }} /> },
  { id: 3, name: 'Explore', path: '/explore', icon: <TravelExploreOutlined sx={{ fontSize: 18 }} /> },
];
// -------------------------------------------------------------------
